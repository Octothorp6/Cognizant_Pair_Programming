...
public class UspsShippingControllerExceptionHandler {

    @ExceptionHandler(value = {MethodArgumentNotValidException.class})
    @ResponseStatus(value = HttpStatus.UNPROCESSABLE_ENTITY)
    public ResponseEntity<VndErrors> UspsShippingControllerValidationError(MethodArgumentNotValidException e, WebRequest request) {
